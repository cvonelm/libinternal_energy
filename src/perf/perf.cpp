...
static int perf_event_open(struct perf_event_attr *attr, pid_t pid, int cpuid, int group_fd, int flags)
{
...
RaplAmdPkgCounter::RaplAmdPkgCounter()
	: PerfCounter(16, 2,0, "RAPL_ENERGY_PKG")
{}
